...
export default function PostJob() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      skills,
      postedAt: new Date().toISOString().slice(0, 19), // "yyyy-MM-ddTHH:mm:ss"
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          <Select value={jobData.jobType} onValueChange={(v) => handleChange("jobType", v)} required>
                        ...
                        <div>
                          ...
                          <Select value={jobData.experienceLevel} onValueChange={(v) => handleChange("experienceLevel", v)} required>
                        ...
                        <div>
                          ...
                          <Select value={jobData.department} onValueChange={(v) => handleChange("department", v)}>
              ...
              <motion.div className="lg:col-span-1 space-y-6" variants={cardStagger}>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(v) => handleChange("featured", Boolean(v))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(v) => handleChange("urgent", Boolean(v))}
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(v) => handleChange("remote", Boolean(v))}
                        />
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(v) => handleChange("acceptApplications", Boolean(v))}
                        />
                ...
                <motion.div variants={cardVariants}>
                  <Card>
                    <CardHeader><CardTitle>Preview & Publish</CardTitle></CardHeader>
                    <CardContent className="space-y-4">
                      <Button variant="outline" className="w-full">Preview Job</Button>
                      <Button type="submit" className="w-full bg-primary hover:bg-primary/90">Publish Job</Button>
